...
T.boxplot.chisq <- ggplot(data1,aes(y=y1)) +
  ...
  labs(title="T.boxplot", subtitle=expression(paste("{",chi[8]^2,", ",italic(n),"=50}")), x="", y="")
...
T.boxplot.NN.chisq <- ggplot(data1, aes(x=x1, y=y1)) +
  ...
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="T.boxplot.NN", subtitle=expression(paste("{",chi[8]^2,", ",italic(n),"=50}")), x="", y="")

C.boxplot.chisq <- ggplot(data1,aes(y=y1)) +
  geom_C.boxplot(fill="purple",width=3) +
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot",subtitle=expression(paste("{",chi[8]^2,", ",italic(n),"=50}")), x="", y="")
...
C.boxplot.NN.chisq <- ggplot(data1, aes(y=y1)) +
  ...
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot.NN", subtitle=expression(paste("{",chi[8]^2,", ",italic(n),"=50}")), x="", y="")
...
T.boxplot.t <- ggplot(data1,aes(y=y2)) +
  ...
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="T.boxplot", subtitle=expression(paste("{",italic(t)[8],", ",italic(n),"=50}")), x="", y="")
...
T.boxplot.NN.t <- ggplot(data1, aes(x=x2, y=y2)) +
  ...
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="T.boxplot.NN", subtitle=expression(paste("{",italic(t)[8],", ",italic(n),"=50}")), x="", y="")

C.boxplot.t <- ggplot(data1,aes(y=y2)) +
  geom_C.boxplot(fill="purple",width=3) +
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot",subtitle=expression(paste("{",italic(t)[8],", ",italic(n),"=50}")), x="", y="")
...
C.boxplot.NN.t <- ggplot(data2, aes(y=y2)) +
  ...
  theme(legend.position = "none") +
  scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot.NN", subtitle=expression(paste("{",italic(t)[8],", ",italic(n),"=50}")), x="", y="")
...
ggsave("Figure_NN_n50.pdf", height=8.5, width=7.5)
