...
T.boxplot.fig1 <- ggplot(data1,aes(y=y1)) +
  ...
  labs(title="T.boxplot", subtitle=expression(paste("{",Exp(1),", ",italic(n),"=50}")), x="", y="")

T.boxplot.fig2 <- ggplot(data2,aes(y=y2)) +
  geom_boxplot(width=3) +
  theme(legend.position = "none") +
  ylim(y.min, y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="T.boxplot", subtitle=expression(paste("{",Exp(1),", ",italic(n),"=500}")), x="", y="")

T.boxplot.fig3 <- ggplot(data3,aes(y=y3)) +
  geom_boxplot(width=3) +
  theme(legend.position = "none") +
  ylim(y.min, y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="T.boxplot", subtitle=expression(paste("{",Exp(1),", ",italic(n),"=5000}")), x="", y="")

T.boxplot.fig4 <- ggplot(data4,aes(y=y4)) +
  geom_boxplot(width=3) +
  theme(legend.position = "none") +
  ylim(y.min, y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="T.boxplot", subtitle=expression(paste("{",Exp(1),", ",italic(n),"=50000}")), x="", y="")
...
C.boxplot.fig1 <- ggplot(data1,aes(y=y1)) +
  ...
  theme(legend.position = "none") +
  ylim(y.min, y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot",subtitle=expression(paste("{",Exp(1),", ",italic(n),"=50}")), x="", y="")

C.boxplot.fig2 <- ggplot(data2,aes(y=y2)) +
  geom_C.boxplot(fill="purple",width=3) +
  theme(legend.position = "none") +
  ylim(y.min, y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot",subtitle=expression(paste("{",Exp(1),", ",italic(n),"=500}")), x="", y="")

C.boxplot.fig3 <- ggplot(data3,aes(y=y3)) +
  geom_C.boxplot(fill="purple",width=3) +
  theme(legend.position = "none") +
  ylim(y.min,y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot",subtitle=expression(paste("{",Exp(1),", ",italic(n),"=5000}")), x="", y="")

C.boxplot.fig4 <- ggplot(data4,aes(y=y4)) +
  geom_C.boxplot(fill="purple",width=3) +
  theme(legend.position = "none") +
  ylim(y.min, y.max) + scale_x_discrete(breaks = NULL) +
  labs(title="C.boxplot", subtitle=expression(paste("{",Exp(1),", ",italic(n),"=50000}")), x="", y="")
...
ggsave("Figure_exponential.pdf", height=8.5, width=7.5)
